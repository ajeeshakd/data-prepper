...
public class KafkaSourceSecurityConfigurer {
    ...
    public static void setSaslPlainTextProperties(final KafkaSourceConfig kafkaSourConfig,
        ...
        String username = saslAuthConfig.getAuthMechanismConfig().getPlainTextAuthConfig().getUsername();
        String password = saslAuthConfig.getAuthMechanismConfig().getPlainTextAuthConfig().getPassword();
        if (saslAuthConfig.getAuthMechanismConfig().getPlainTextAuthConfig() != null) {
            properties.put(SASL_MECHANISM, PLAIN_MECHANISM);
        }
        if (saslAuthConfig.getAuthProtocolConfig() != null) {
            if (StringUtils.isNotEmpty(saslAuthConfig.getAuthProtocolConfig().getPlaintext()) &&
    ...
    public static void setOauthProperties(final KafkaSourceConfig kafkaSourConfig,
                                          final Properties properties) {
        final OAuthConfig oAuthConfig = kafkaSourConfig.getAuthConfig().getSaslAuthConfig().getAuthMechanismConfig().getOAuthConfig();
