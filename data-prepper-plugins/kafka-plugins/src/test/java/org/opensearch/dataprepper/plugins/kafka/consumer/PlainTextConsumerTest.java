...
class PlainTextConsumerTest {
    ...
    void testPlainTextConsumeRecords_catch_block() {
        ...
        doCallRealMethod().when(spyConsumer).consumeRecords(kafkaPlainTextConsumer, status, buffer, topicsConfig,
                sourceConfig, pluginMetrics, "plaintext");
        spyConsumer.consumeRecords(kafkaPlainTextConsumer, status, buffer, topicsConfig, sourceConfig, pluginMetrics, "plaintext");
        verify(spyConsumer).consumeRecords(kafkaPlainTextConsumer, status, buffer, topicsConfig, sourceConfig, pluginMetrics, "plaintext");
    }
